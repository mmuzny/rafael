...
abstract class BaseRegionPeer {
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseRegionPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseRegionPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseRegionPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseRegionPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseRegionPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseRegionPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseRegionPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseRegionPeer', $values, $con, $ret);
    }

...
abstract class BaseCar extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the factory field.
	 * @var        string
	 */
	protected $factory;
	...
	/**
	 * Set the value of [factory] column.
	 * 
	 * @param      string $v new value
	 * @return     Car The current object (for fluent API support)
	 */
	public function setFactory($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->factory !== $v) {
			$this->factory = $v;
			$this->modifiedColumns[] = CarPeer::FACTORY;
		}
	...
	public function setType($v)
	{
		...
		if ($this->type !== $v) {
			$this->type = $v;
			$this->modifiedColumns[] = CarPeer::TYPE;
		}
	...
	public function setYear($v)
	{
		...
		if ($this->year !== $v) {
			$this->year = $v;
			$this->modifiedColumns[] = CarPeer::YEAR;
		}
	...
	public function setAssignment($v)
	{
		...
		if ($this->assignment !== $v) {
			$this->assignment = $v;
			$this->modifiedColumns[] = CarPeer::ASSIGNMENT;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->factory = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->type = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->year = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->assignment = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->resetModified();
			...
			return $startcol + 7; // 7 = CarPeer::NUM_COLUMNS - CarPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[1] => $this->getName(),
			$keys[2] => $this->getSPZ(),
			$keys[3] => $this->getFactory(),
			$keys[4] => $this->getType(),
			$keys[5] => $this->getYear(),
			$keys[6] => $this->getAssignment(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setFactory($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setType($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setYear($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setAssignment($arr[$keys[6]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CarPeer::FACTORY)) $criteria->add(CarPeer::FACTORY, $this->factory);
		if ($this->isColumnModified(CarPeer::TYPE)) $criteria->add(CarPeer::TYPE, $this->type);
		if ($this->isColumnModified(CarPeer::YEAR)) $criteria->add(CarPeer::YEAR, $this->year);
		if ($this->isColumnModified(CarPeer::ASSIGNMENT)) $criteria->add(CarPeer::ASSIGNMENT, $this->assignment);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setFactory($this->factory);

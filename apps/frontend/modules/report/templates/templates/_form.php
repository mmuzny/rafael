...
<?php endif; ?>
  <table class="jobs">
    <tfoot>
      <tr>
        <td colspan="2">
          &nbsp;<a href="<?php echo url_for('report/index') ?>">Zpět na seznam</a>
          <?php if (!$form->getObject()->isNew()): ?>
            &nbsp;<?php echo link_to('Odstranit', 'report/delete?id='.$form->getObject()->getId(), array('method' => 'delete', 'confirm' => 'Opravdu chcete odstranit?')) ?>
          <?php endif; ?>
